...
class ClientRigSelectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(ClientRigSelectController());
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => _RigDropdown<ClientModel>(
                    ...
                    items: controller.clients.toList(), // ✅ plain List
                    itemLabel: (c) => c.name,
                  ...
                  Obx(() => _RigDropdown<RigModel>(
                    ...
                    items: controller.rigs.toList(), // ✅ plain List
                    itemLabel: (r) => r.name,
